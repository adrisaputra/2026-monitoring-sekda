    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{ asset('backend/assets/img/90x90.jpg') }}"> <span class="navbar-brand-name">CORK</span></a>
            </div>
                ...
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        ...
                        <div class="dropdown-menu dropdown-menu-right animated fadeInUp" aria-labelledby="customDropdown">
                            <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);"><img src="{{ asset('backend/assets/img/de.png') }}" class="flag-width" alt="flag"> German</a>
                            <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);"><img src="{{ asset('backend/assets/img/jp.png') }}" class="flag-width" alt="flag"> Japanese</a>
                            <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="{{ asset('backend/assets/img/fr.png') }}" class="flag-width" alt="flag"> French</a>
                            <a class="dropdown-item" data-img-value="ca" data-value="en" href="javascript:void(0);"><img src="{{ asset('backend/assets/img/ca.png') }}" class="flag-width" alt="flag"> English</a>
                        </div>
                    </div>
                </li>
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="{{ url('office') }}" class="dropdown-toggle autodroprown">
                    ...
                    <li class="menu single-menu">
                        <a href="{{ url('user') }}" class="dropdown-toggle autodroprown">
                            <img src="{{ asset('menu/icons8-customer-100.png') }}" width="30" height="30" >
                            <div style="padding-left:5px;padding-top:3px">
                                <span>User</span>
                            </div>
