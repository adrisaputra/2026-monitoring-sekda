                    ...
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
						...
						@include('admin.office.create')
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover mb-12" id="office-table">
									<thead>
										<tr>
...
<script>
    ...
    function getData(id){
        ...
        var url = "{{ url('/office/edit') }}";
        $.ajax({
            url: url + "/" + id,
            type: "GET",
            success: function (response) {
                document.getElementById("id_office").value = response.data.id;
